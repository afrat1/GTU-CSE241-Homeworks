...
tetraminos::tetraminos(char tetramino_type){ //it allows to reach the tetraminos
    if(tetramino_type == 'T'){
        arr = {
            {' ',' ', ' ', ' '},
            {' ',' ', ' ', ' '},
